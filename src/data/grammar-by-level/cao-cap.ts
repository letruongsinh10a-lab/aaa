...
export const grammarCaoCap: GrammarEntry[] = [
  ...
  },
  {
    ...
    sectionTitleVi: 'Trích dẫn',
    conjugationTable: [
      { stemType: 'Tính từ', baseForm: '좋다', conjugated: '좋다면서' },
      { stemType: 'Động từ (phụ âm cuối)', baseForm: '먹다', conjugated: '먹는다면서' },
      { stemType: 'Động từ (nguyên âm cuối)', baseForm: '가다', conjugated: '간다면서' },
    ],
  },
  {
    id: 'gr-cao-cap-30',
    ...
    sectionTitleVi: 'Trích dẫn',
    conjugationTable: [
      { stemType: 'Tính từ', baseForm: '예쁘다', conjugated: '예쁘다거나' },
      { stemType: 'Động từ (phụ âm cuối)', baseForm: '먹다', conjugated: '먹는다거나' },
      { stemType: 'Động từ (nguyên âm cuối)', baseForm: '가다', conjugated: '간다거나' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-07', distinction: '-다거나 là dạng trích dẫn gián tiếp của cấu trúc lựa chọn -거나, cần chia động từ/tính từ về dạng trần thuật (-다) trước khi gắn 거나, khác với -거나 thông thường gắn trực tiếp vào thân từ.' },
    ],
  },
  {
    id: 'gr-cao-cap-31',
  ...
  },
  {
    ...
    sectionTitleVi: 'Trích dẫn',
    relatedPatterns: [
      { id: 'gr-cao-cap-29', distinction: '-다건만 luôn hàm ý tương phản, bất ngờ giữa điều đã nghe và thực tế, khác với -다면서 vốn mang tính trích dẫn trung lập, không có sắc thái tương phản.' },
    ],
  },
  {
    id: 'gr-cao-cap-33',
  ...
  },
  {
    ...
    sectionTitleVi: 'Trích dẫn',
    relatedPatterns: [
      { id: 'gr-so-cap-07', distinction: '-다든가/-다든지 là dạng trích dẫn dùng khi liệt kê lời nói/quyết định được nêu ra, còn -거나 -거나 thông thường dùng cho hành động/trạng thái trực tiếp, không qua trích dẫn.' },
    ],
  },
  {
    id: 'gr-cao-cap-37',
    ...
    sectionTitleVi: 'Trích dẫn',
    conjugationTable: [
      { stemType: 'Tính từ', baseForm: '바쁘다', conjugated: '바쁘다손 치더라도' },
      { stemType: 'Động từ (phụ âm cuối)', baseForm: '먹다', conjugated: '먹는다손 치더라도' },
      { stemType: 'Động từ (nguyên âm cuối)', baseForm: '가다', conjugated: '간다손 치더라도' },
    ],
  },
  {
    id: 'gr-cao-cap-38',
  ...
  },
  {
    ...
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '믿다', conjugated: '믿음' },
      { stemType: 'Quy tắc (nguyên âm cuối, chỉ thêm ㅁ)', baseForm: '기쁘다', conjugated: '기쁨' },
      { stemType: 'ㄹ 받침 (thêm ㅁ trực tiếp)', baseForm: '살다', conjugated: '삶' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '돕다', conjugated: '도움' },
    ],
  },
  {
    id: 'gr-cao-cap-40',
  ...
  },
  {
    ...
    relatedPatterns: [
      { id: 'gr-cao-cap-45', distinction: '-더라도 trung tính hơn, chỉ nói kết quả vế sau không phụ thuộc vào vế trước; còn -(으)ㄴ들 nhấn mạnh kết quả vế sau hoàn toàn trái với mong đợi, thường mang sắc thái phủ định mạnh hơn.' },
    ],
  },
  {
    id: 'gr-cao-cap-43',
    ...
    relatedPatterns: [
      { id: 'gr-cao-cap-37', distinction: 'Cùng một cấu trúc gốc với -(느)ㄴ다손 치더라도 ở mục Trích dẫn, chỉ khác cách viết rút gọn không ghi rõ 느ㄴ trước 다손.' },
    ],
  },
  {
    id: 'gr-cao-cap-44',
    ...
    sectionTitleVi: 'Tình huống giả định, nhượng bộ',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '작다', conjugated: '작을지라도' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '뛰어나다', conjugated: '뛰어날지라도' },
      { stemType: 'ㄹ 받침 (lược 으, giữ nguyên ㄹ gốc)', baseForm: '알다', conjugated: '알지라도' },
    ],
    relatedPatterns: [
      { id: 'gr-cao-cap-49', distinction: 'Ví dụ minh họa cho thấy -(으)ㄹ지라도 và -(으)ㄹ지언정 gần như thay thế được cho nhau; -(으)ㄹ지언정 thiên về vế sau mang tính phủ định mạnh hơn.' },
    ],
  },
  {
    id: 'gr-cao-cap-45',
    ...
    sectionTitleVi: 'Tình huống giả định, nhượng bộ',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '받다', conjugated: '받은들' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '하다', conjugated: '한들' },
      { stemType: 'ㄹ 받침 (lược ㄹ trước ㄴ)', baseForm: '알다', conjugated: '안들' },
    ],
    relatedPatterns: [
      { id: 'gr-cao-cap-44', distinction: '-(으)ㄴ들 nhấn mạnh kết quả trái với dự kiến mang tính thất bại, gần nghĩa với cách nói "다 할지라도" (biến thể của -(으)ㄹ지라도) nhưng cô đọng và mang tính khẩu ngữ hơn.' },
    ],
  },
  {
    id: 'gr-cao-cap-46',
    ...
    commonMistakes: [
      ...
      'Ví dụ thứ hai trong nguồn thực chất không dùng đuôi -(으)ㄹ 망정 mà dùng 아무리...해도 — cần lưu ý đây là hai cấu trúc nhượng bộ khác nhau dù cùng nhóm ngữ nghĩa, không phải ví dụ minh họa chuẩn cho -(으)ㄹ 망정.',
    ],
    level: 'cao-cap',
    section: 'gia-dinh-nhuong-bo',
    sectionOrder: 5,
    sectionTitleVi: 'Tình huống giả định, nhượng bộ',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹을망정' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '갈망정' },
      { stemType: 'ㄹ 받침 (lược 으, giữ nguyên ㄹ gốc)', baseForm: '살다', conjugated: '살망정' },
    ],
  },
  {
    id: 'gr-cao-cap-47',
    ...
    sectionTitleVi: 'Tình huống giả định, nhượng bộ',
    conjugationTable: [
      { stemType: 'Tính từ / Danh từ + 이다', baseForm: '좋다', conjugated: '좋다고 치다' },
      { stemType: 'Động từ (phụ âm cuối)', baseForm: '먹다', conjugated: '먹는다고 치다' },
      { stemType: 'Động từ (nguyên âm cuối)', baseForm: '가다', conjugated: '간다고 치다' },
    ],
    relatedPatterns: [
      { id: 'gr-cao-cap-48', distinction: '-는다고 치다 thiên về giả định một hoàn cảnh để tiếp tục bàn luận, còn -는 셈 치다 thiên về coi một hành động/kết quả tương đương với việc khác để tự thuyết phục bản thân.' },
    ],
  },
  {
    id: 'gr-cao-cap-48',
    ...
    sectionTitleVi: 'Tình huống giả định, nhượng bộ',
    relatedPatterns: [
      { id: 'gr-cao-cap-47', distinction: '-는 셈 치다 thiên về "coi một hành động/kết quả tương đương với việc khác" để tự thuyết phục bản thân, khác với -(느)ㄴ다고 치다 vốn thiên về giả định một hoàn cảnh để tiếp tục bàn luận.' },
    ],
  },
  {
    id: 'gr-cao-cap-49',
    ...
    sectionTitleVi: 'Tình huống giả định, nhượng bộ',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '작다', conjugated: '작을지언정' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가난하다', conjugated: '가난할지언정' },
      { stemType: 'ㄹ 받침 (lược 으, giữ nguyên ㄹ gốc)', baseForm: '알다', conjugated: '알지언정' },
    ],
    relatedPatterns: [
      { id: 'gr-cao-cap-44', distinction: '-(으)ㄹ지언정 thiên về vế sau mang tính phủ định/quyết tâm mạnh mẽ, còn -(으)ㄹ지라도 trung tính hơn, không bắt buộc vế sau phải phủ định.' },
    ],
  },
  {
    id: 'gr-cao-cap-50',
    ...
    sectionTitleVi: 'Tình huống giả định, nhượng bộ',
    conjugationTable: [
      { stemType: 'Quy tắc (âm dương, ㅏ/ㅗ)', baseForm: '가다', conjugated: '가 봤자' },
      { stemType: 'Quy tắc (âm âm, khác ㅏ/ㅗ)', baseForm: '먹다', conjugated: '먹어 봤자' },
      { stemType: '하다 bất quy tắc', baseForm: '노력하다', conjugated: '노력해 봤자' },
    ],
  },
  {
    id: 'gr-cao-cap-51',
  ...
  },
  {
    ...
    sectionTitleVi: 'Hành động tuần tự',
    relatedPatterns: [
      { id: 'gr-cao-cap-53', distinction: '-자 mô tả sự việc mang tính nhân quả tự nhiên đã xảy ra trong quá khứ, vế sau không chia mệnh lệnh/cầu khiến; khác với -는 대로 vốn dùng cho kế hoạch, mệnh lệnh trong hiện tại/tương lai.' },
    ],
  },
  {
    id: 'gr-cao-cap-53',
    ...
    sectionTitleVi: 'Hành động tuần tự',
    relatedPatterns: [
      { id: 'gr-cao-cap-52', distinction: '-는 대로 dùng cho kế hoạch, mệnh lệnh, lời hứa trong hiện tại/tương lai (vế sau không chia quá khứ); khác với V-자 vốn chỉ mô tả sự việc đã xảy ra trong quá khứ theo trình tự tự nhiên.' },
    ],
  },
  {
    id: 'gr-cao-cap-54',
  ...
  },
  {
    ...
    commonMistakes: [
      ...
      'Ví dụ đầu trong nguồn gốc ghi nhầm tiểu từ "시간이 내서" — 내다 (bỏ ra, dành ra) là động từ cần tân ngữ nên phải dùng "시간을 내서", không dùng chủ ngữ "시간이" với 내다.',
    ],
    level: 'cao-cap',
    section: 'dieu-kien-quyet-dinh',
    sectionOrder: 7,
    sectionTitleVi: 'Điều kiện và quyết định',
    conjugationTable: [
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '갈라치면' },
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹을라치면' },
      { stemType: 'ㄹ 받침 (lược 으, giữ nguyên ㄹ gốc)', baseForm: '살다', conjugated: '살라치면' },
    ],
  },
  {
    id: 'gr-cao-cap-56',
  ...
  },
  {
    ...
    sectionTitleVi: 'Điều kiện và quyết định',
    conjugationTable: [
      { stemType: 'Động từ (mọi loại, kể cả 있다/없다)', baseForm: '가다', conjugated: '가느냐에 달려 있다' },
      { stemType: 'Tính từ, phụ âm cuối', baseForm: '좋다', conjugated: '좋으냐에 달려 있다' },
      { stemType: 'Tính từ, nguyên âm cuối', baseForm: '크다', conjugated: '크냐에 달려 있다' },
    ],
  },
  {
    id: 'gr-cao-cap-60',
  ...
  },
  {
    ...
    relatedPatterns: [
      { id: 'gr-trung-cap-09', distinction: '-건만 gần nghĩa với -(으)ㄴ/는데도 nhưng nhấn mạnh rõ hơn cảm xúc bất mãn, tiếc nuối của người nói và mang tính văn viết hơn.' },
    ],
  },
  {
    id: 'gr-cao-cap-63',
    ...
    sectionTitleVi: 'Tương phản và đối lập',
    relatedPatterns: [
      { id: 'gr-cao-cap-62', distinction: '-고도 bắt buộc hai vế phải cùng chủ ngữ, khác với -건만 vốn không đòi hỏi điều kiện chủ ngữ đồng nhất.' },
      { id: 'gr-trung-cap-09', distinction: '-고도 bắt buộc hai vế phải cùng chủ ngữ, khác với -(으)ㄴ/는데도 vốn không đòi hỏi điều kiện chủ ngữ đồng nhất.' },
    ],
  },
  {
    id: 'gr-cao-cap-64',
  ...
  },
  {
    ...
    sectionTitleVi: 'Bổ sung và bao gồm',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '높다', conjugated: '높으려니와' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '되다', conjugated: '되려니와' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '따갑다', conjugated: '따가우려니와' },
      { stemType: 'ㄹ 받침 (không thêm 으)', baseForm: '힘들다', conjugated: '힘들려니와' },
    ],
    relatedPatterns: [
      { id: 'gr-cao-cap-66', distinction: '-(으)려니와 mang thêm sắc thái phỏng đoán khi công nhận vế trước, khác với -거니와 chỉ công nhận một thực tế đã biết chắc chắn.' },
    ],
  },
  {
    id: 'gr-cao-cap-68',
    ...
    sectionTitleVi: 'Bổ sung và bao gồm',
    conjugationTable: [
      { stemType: 'Động từ/Tính từ', baseForm: '가다', conjugated: '가기는커녕' },
      { stemType: 'Danh từ', baseForm: '소개', conjugated: '소개는커녕' },
    ],
  },
  {
    id: 'gr-cao-cap-69',
    ...
    sectionTitleVi: 'Bổ sung và bao gồm',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '좋다', conjugated: '좋을 뿐더러' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '예쁘다', conjugated: '예쁠 뿐더러' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추울 뿐더러' },
      { stemType: 'ㄹ 받침 (lược 으, giữ nguyên ㄹ gốc)', baseForm: '알다', conjugated: '알 뿐더러' },
    ],
    relatedPatterns: [
      { id: 'gr-cao-cap-66', distinction: '-(으)ㄹ 뿐더러 bắt buộc chủ ngữ hai vế phải giống nhau, khác với -거니와 vốn không đòi hỏi điều kiện chủ ngữ đồng nhất.' },
    ],
  },
  {
    id: 'gr-cao-cap-70',
  ...
  },
  {
    ...
    conjugationTable: [
      { stemType: 'Quy tắc (âm dương, ㅏ/ㅗ)', baseForm: '놀다', conjugated: '놀아 대다' },
      { stemType: 'Quy tắc (âm âm, khác ㅏ/ㅗ)', baseForm: '먹다', conjugated: '먹어 대다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '덥다', conjugated: '더워 대다' },
      { stemType: '르 bất quy tắc', baseForm: '두르다', conjugated: '둘러 대다' },
    ],
  },
  ...
  },
  {
    ...
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '없다', conjugated: '없으리만치' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '아프다', conjugated: '아프리만치' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '아름답다', conjugated: '아름다우리만치' },
      { stemType: 'ㄹ 받침 (lược 으, giữ nguyên ㄹ gốc)', baseForm: '알다', conjugated: '알리만치' },
    ],
  },
  {
    id: 'gr-cao-cap-76',
  ...
  },
  {
    ...
    sectionTitleVi: 'Ý đồ',
    conjugationTable: [
      { stemType: 'Động từ, phụ âm cuối', baseForm: '먹다', conjugated: '먹는다는 것이' },
      { stemType: 'Động từ, nguyên âm cuối', baseForm: '가다', conjugated: '간다는 것이' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '살다', conjugated: '산다는 것이' },
    ],
  },
  {
    id: 'gr-cao-cap-78',
    ...
    sectionTitleVi: 'Ý đồ',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹으려고 들다' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '사다', conjugated: '사려고 들다' },
      { stemType: 'ㄹ 받침 (không thêm 으)', baseForm: '팔다', conjugated: '팔려고 들다' },
    ],
  },
  {
    id: 'gr-cao-cap-79',
    ...
    sectionTitleVi: 'Ý đồ',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹으려다가' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '가려다가' },
      { stemType: 'ㄹ 받침 (không thêm 으)', baseForm: '팔다', conjugated: '팔려다가' },
    ],
    relatedPatterns: [
      { id: 'gr-cao-cap-77', distinction: '-(으)려다가 nhấn mạnh việc chủ thể chủ động đổi ý giữa chừng trước khi hành động ban đầu diễn ra, khác với -(느)ㄴ다는 것이 vốn diễn tả kết quả ngoài ý muốn xảy ra ngay lập tức, không kịp đổi ý.' },
    ],
  },
  {
    id: 'gr-cao-cap-80',
    ...
    conjugationTable: [
      { stemType: 'Động từ, đã xảy ra', baseForm: '죽다', conjugated: '죽은 듯이' },
      { stemType: 'Động từ/Tính từ, suy đoán/tương lai', baseForm: '막히다', conjugated: '막힐 듯이' },
    ],
    relatedPatterns: [
      { id: 'gr-cao-cap-64', distinction: '-는 듯이 thiên về ví von, phóng đại mức độ bằng hình ảnh so sánh sinh động, khác với -듯이 (mục Tương đồng) chỉ sự tương tự khách quan, trung tính giữa hai sự việc.' },
    ],
  },
  {
    id: 'gr-cao-cap-81',
    ...
    sectionTitleVi: 'Dự đoán và khả năng',
    conjugationTable: [
      { stemType: 'Động từ, phụ âm cuối', baseForm: '먹다', conjugated: '먹는다는 듯이' },
      { stemType: 'Động từ, nguyên âm cuối/ㄹ 받침', baseForm: '들다', conjugated: '든다는 듯이' },
      { stemType: 'Tính từ', baseForm: '지루하다', conjugated: '지루하다는 듯이' },
    ],
  },
  {
    id: 'gr-cao-cap-82',
    ...
    sectionTitleVi: 'Dự đoán và khả năng',
    conjugationTable: [
      { stemType: 'Động từ, quá khứ', baseForm: '받다', conjugated: '받은 듯하다' },
      { stemType: 'Động từ, hiện tại', baseForm: '오다', conjugated: '오는 듯하다' },
      { stemType: 'Động từ/Tính từ, tương lai/suy đoán', baseForm: '미치다', conjugated: '미칠 듯하다' },
      { stemType: 'Tính từ, hiện tại', baseForm: '좋다', conjugated: '좋은 듯하다' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-53', distinction: '-(으)ㄴ/는/(으)ㄹ 듯하다 mang sắc thái trang trọng hơn -(으)ㄴ/는/(으)ㄹ 것 같다, thường dùng trong văn viết hoặc lời nói lịch sự.' },
    ],
  },
  {
    id: 'gr-cao-cap-83',
    ...
    sectionTitleVi: 'Dự đoán và khả năng',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '늦다', conjugated: '늦을 게 뻔하다' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '갈 게 뻔하다' },
      { stemType: 'ㄹ 받침 (lược 으, giữ nguyên ㄹ gốc)', baseForm: '놀다', conjugated: '놀 게 뻔하다' },
    ],
  },
  {
    id: 'gr-cao-cap-84',
    ...
    sectionTitleVi: 'Dự đoán và khả năng',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '있다', conjugated: '있을 법하다' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '오다', conjugated: '올 법하다' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '알다', conjugated: '알 법하다' },
    ],
  },
  {
    id: 'gr-cao-cap-85',
    ...
    sectionTitleVi: 'Dự đoán và khả năng',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '없다', conjugated: '없을 리가 없다' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '뜨다', conjugated: '뜰 리가 없다' },
      { stemType: 'ㄹ 받침 (lược 으, giữ nguyên ㄹ gốc)', baseForm: '알다', conjugated: '알 리가 없다' },
    ],
  },
  {
    id: 'gr-cao-cap-86',
  ...
  },
  {
    ...
    relatedPatterns: [
      { id: 'gr-cao-cap-88', distinction: 'Gần như đồng nghĩa hoàn toàn với -는 법이다 và có thể thay thế lẫn nhau trong hầu hết ngữ cảnh diễn đạt sự đương nhiên.' },
    ],
  },
  {
    id: 'gr-cao-cap-88',
    ...
    sectionTitleVi: 'Sự đương nhiên',
    conjugationTable: [
      { stemType: 'Động từ', baseForm: '드러나다', conjugated: '드러나는 법이다' },
      { stemType: 'Tính từ, phụ âm cuối', baseForm: '싫다', conjugated: '싫은 법이다' },
      { stemType: 'Tính từ, nguyên âm cuối', baseForm: '크다', conjugated: '큰 법이다' },
    ],
    relatedPatterns: [
      { id: 'gr-cao-cap-87', distinction: 'Gần như đồng nghĩa hoàn toàn với -기 마련이다 và có thể dùng thay thế lẫn nhau trong hầu hết ngữ cảnh diễn đạt sự đương nhiên.' },
    ],
  },
  {
    id: 'gr-cao-cap-89',
    ...
    conjugationTable: [
      { stemType: 'Tính từ, phụ âm cuối', baseForm: '많다', conjugated: '많은가 하면' },
      { stemType: 'Tính từ, nguyên âm cuối', baseForm: '크다', conjugated: '큰가 하면' },
      { stemType: 'Động từ (quy tắc)', baseForm: '가다', conjugated: '가는가 하면' },
      { stemType: 'Động từ, ㄹ 받침 (lược ㄹ)', baseForm: '살다', conjugated: '사는가 하면' },
    ],
  },
  {
    id: 'gr-cao-cap-90',
    ...
    sectionTitleVi: 'Liệt kê',
    conjugationTable: [
      { stemType: 'Tính từ (하다, không cần 으)', baseForm: '복잡하다', conjugated: '복잡하니' },
      { stemType: 'Tính từ (quy tắc, cần 으)', baseForm: '좋다', conjugated: '좋으니' },
      { stemType: 'Động từ (bất kể batchim, dùng -느니)', baseForm: '가다', conjugated: '가느니' },
    ],
  },
  {
    id: 'gr-cao-cap-91',
    ...
    sectionTitleVi: 'Liệt kê',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹으랴' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '가랴' },
      { stemType: 'ㄹ 받침 (không thêm 으)', baseForm: '놀다', conjugated: '놀랴' },
    ],
  },
  {
    id: 'gr-cao-cap-92',
    ...
    sectionTitleVi: 'Liệt kê',
    conjugationTable: [
      { stemType: 'Danh từ kết thúc phụ âm', baseForm: '집', conjugated: '집이며' },
      { stemType: 'Danh từ kết thúc nguyên âm', baseForm: '자동차', conjugated: '자동차며' },
    ],
  },
  {
    id: 'gr-cao-cap-93',
    ...
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '겪다', conjugated: '겪은 끝에' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '고민하다', conjugated: '고민한 끝에' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '살다', conjugated: '산 끝에' },
    ],
  },
  {
    id: 'gr-cao-cap-94',
    ...
    sectionTitleVi: 'Kết quả và hồi tưởng',
    conjugationTable: [
      { stemType: 'Quy tắc (ㅏ/ㅗ)', baseForm: '알다', conjugated: '알아내다' },
      { stemType: '하다 bất quy tắc', baseForm: '하다', conjugated: '해내다' },
      { stemType: 'Quy tắc (ㅣ + 어 → 여)', baseForm: '이기다', conjugated: '이겨 내다' },
    ],
  },
  {
    id: 'gr-cao-cap-95',
  ...
  },
  {
    ...
    conjugationTable: [
      { stemType: 'Động từ (quy tắc)', baseForm: '내리다', conjugated: '내리는 가운데' },
      { stemType: 'Tính từ, phụ âm cuối', baseForm: '많다', conjugated: '많은 가운데' },
      { stemType: 'Tính từ, nguyên âm cuối', baseForm: '바쁘다', conjugated: '바쁜 가운데' },
      { stemType: 'ㄹ 받침 (động từ, lược ㄹ)', baseForm: '살다', conjugated: '사는 가운데' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-01', distinction: 'Vế trước của -(으)ㄴ/는 가운데 chỉ nêu bối cảnh nền đang tiếp diễn, không dùng để nêu nguyên nhân trực tiếp như -아/어서.' },
    ],
  },
  {
    id: 'gr-cao-cap-97',
    ...
    sectionTitleVi: 'Tình huống hoặc tiêu chuẩn',
    conjugationTable: [
      { stemType: 'Động từ, quá khứ', baseForm: '어려워지다', conjugated: '어려워진 마당에' },
      { stemType: 'Động từ, hiện tại', baseForm: '끝나다', conjugated: '끝나는 마당에' },
      { stemType: 'ㄹ 받침 (hiện tại, lược ㄹ)', baseForm: '살다', conjugated: '사는 마당에' },
    ],
  },
  {
    id: 'gr-cao-cap-98',
  ...
  },
  {
    ...
    sectionTitleVi: 'Tình huống hoặc tiêu chuẩn',
    conjugationTable: [
      { stemType: 'Tính từ/Động từ, phụ âm cuối', baseForm: '많다', conjugated: '많음에 따라' },
      { stemType: 'Động từ, nguyên âm cuối', baseForm: '높아지다', conjugated: '높아짐에 따라' },
      { stemType: 'ㄹ 받침 (kết hợp trực tiếp thành ㄻ)', baseForm: '살다', conjugated: '삶에 따라' },
    ],
  },
  {
    id: 'gr-cao-cap-100',
  ...
  },
  {
    ...
    sectionTitleVi: 'Nhấn mạnh',
    relatedPatterns: [
      { id: 'gr-cao-cap-102', distinction: 'Gần như đồng nghĩa hoàn toàn với -기 짝이 없다, có thể dùng thay thế lẫn nhau trong hầu hết ngữ cảnh nhấn mạnh mức độ.' },
    ],
  },
  {
    id: 'gr-cao-cap-102',
    ...
    sectionTitleVi: 'Nhấn mạnh',
    relatedPatterns: [
      { id: 'gr-cao-cap-101', distinction: 'Có thể dùng thay thế lẫn nhau với -기가 이를 데 없다; chỉ kết hợp với tính từ, không dùng với động từ.' },
    ],
  },
  {
    id: 'gr-cao-cap-103',
    ...
    sectionTitleVi: 'Nhấn mạnh',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '찾다', conjugated: '찾을래야' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '갈래야' },
      { stemType: 'ㄹ 받침 (không thêm 으)', baseForm: '팔다', conjugated: '팔래야' },
    ],
  },
  {
    id: 'gr-cao-cap-104',
    ...
    examples: [
      { ko: '비록 실패했지만 좋은 경험이 되었어요.', vi: 'Dù đã thất bại nhưng đó là một trải nghiệm tốt.', romanization: 'bi-rok sil-pae-haet-jji-man jo-eun gyeong-heo-mi doe-eo-sseo-yo', register: 'polite' },
