...
export const grammarTrungCap: GrammarEntry[] = [
  ...
  },
  {
    ...
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '먹다', conjugated: '먹는 사이에' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '놀다', conjugated: '노는 사이에' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-19', distinction: '-는 사이에 nhấn mạnh khoảng thời gian ngắn và bất ngờ, còn -는 동안 chỉ khoảng thời gian dài hơn, mang tính trung tính hơn.' },
      { id: 'gr-so-cap-21', distinction: 'Nếu hai vế cùng chủ ngữ, nên cân nhắc dùng -다가 thay cho -는 사이에 để câu tự nhiên hơn.' },
    ],
  },
  {
    id: 'gr-trung-cap-12',
    ...
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '먹다', conjugated: '먹어야' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추워야' },
      { stemType: '르 bất quy tắc', baseForm: '다르다', conjugated: '달라야' },
      { stemType: 'ㄷ bất quy tắc', baseForm: '듣다', conjugated: '들어야' },
      { stemType: 'ㅎ bất quy tắc', baseForm: '그렇다', conjugated: '그래야' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-46', distinction: 'Nếu chỉ là điều kiện thông thường, không bắt buộc, nên dùng -(으)면 thay cho -아/어야 vốn nhấn mạnh điều kiện thiết yếu.' },
    ],
  },
  {
    id: 'gr-trung-cap-13',
    ...
    sectionTitleVi: 'Diễn tả điều kiện và giả định',
    relatedPatterns: [
      { id: 'gr-so-cap-46', distinction: 'Vế sau của -거든 bắt buộc phải là mệnh lệnh/cầu khiến/hứa hẹn hay ý chí, không dùng cho câu trần thuật đơn thuần — khác với -(으)면 dùng được cho mọi loại câu.' },
      { id: 'gr-trung-cap-01', distinction: '-거든 ở đây luôn nằm giữa câu mang nghĩa điều kiện, khác với -거든요 (mục 1) dùng ở cuối câu để giải thích lý do.' },
    ],
  },
  {
    id: 'gr-trung-cap-14',
    ...
    sectionTitleVi: 'Diễn tả điều kiện và giả định',
    conjugationTable: [
      { stemType: 'Tính từ', baseForm: '많다', conjugated: '많다면' },
      { stemType: 'Động từ (nguyên âm cuối)', baseForm: '가다', conjugated: '간다면' },
      { stemType: 'Động từ (phụ âm cuối)', baseForm: '먹다', conjugated: '먹는다면' },
      { stemType: 'ㄹ 받침 (động từ, lược ㄹ)', baseForm: '살다', conjugated: '산다면' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-46', distinction: '-(ㄴ/는)다면 dùng cho giả định khó xảy ra hoặc gần như không có khả năng xảy ra, khác với -(으)면 vốn dùng cho điều kiện có khả năng xảy ra bình thường.' },
    ],
  },
  {
    id: 'gr-trung-cap-15',
    ...
    sectionTitleVi: 'Diễn tả điều kiện và giả định',
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '먹다', conjugated: '먹었더라면' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추웠더라면' },
      { stemType: '르 bất quy tắc', baseForm: '다르다', conjugated: '달랐더라면' },
      { stemType: 'ㅎ bất quy tắc', baseForm: '그렇다', conjugated: '그랬더라면' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-14', distinction: 'Đây là giả định TRÁI VỚI SỰ THẬT đã xảy ra trong quá khứ, khác hẳn -(ㄴ/는)다면 (mục 14) vốn giả định về tương lai hoặc điều chưa xảy ra.' },
    ],
  },
  {
    id: 'gr-trung-cap-16',
    ...
    sectionTitleVi: 'Diễn tả điều kiện và giả định',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹을 뻔하다' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '갈 뻔하다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추울 뻔하다' },
      { stemType: 'ㄷ bất quy tắc', baseForm: '듣다', conjugated: '들을 뻔하다' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '놀다', conjugated: '놀 뻔하다' },
    ],
  },
  {
    id: 'gr-trung-cap-17',
    ...
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '좋다', conjugated: '좋아 보이다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '덥다', conjugated: '더워 보이다' },
      { stemType: '르 bất quy tắc', baseForm: '다르다', conjugated: '달라 보이다' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '예쁘다', conjugated: '예뻐 보이다' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-53', distinction: 'Với động từ, muốn diễn đạt ý tương tự phải dùng -는 것 같다 (dùng được cho cả suy đoán gián tiếp, không cần nhìn thấy), vì -아/어 보이다 chỉ kết hợp được với tính từ và dựa trên những gì mắt thấy trực tiếp.' },
      { id: 'gr-trung-cap-24', distinction: 'Với động từ, muốn diễn đạt ý phỏng đoán tương tự phải dùng -나 보다, vì -아/어 보이다 chỉ kết hợp được với tính từ.' },
    ],
  },
  {
    id: 'gr-trung-cap-18',
    ...
    conjugationTable: [
      ...
      { stemType: 'ㄷ bất quy tắc', baseForm: '듣다', conjugated: '들을 텐데' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '힘들다', conjugated: '힘들 텐데' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-19', distinction: '-(으)ㄹ 텐데 thiên về nêu bối cảnh phỏng đoán, còn -(으)ㄹ 테니까 (mục 19) thiên về giải thích lý do kèm theo lời khuyên hay đề nghị.' },
    ],
  },
  {
    id: 'gr-trung-cap-19',
    ...
    conjugationTable: [
      ...
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '놀다', conjugated: '놀 테니까' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-18', distinction: '-(으)ㄹ 테니까 thiên về giải thích lý do kèm lời khuyên/đề nghị, còn -(으)ㄹ 텐데 nhấn mạnh bối cảnh phỏng đoán.' },
    ],
  },
  {
    id: 'gr-trung-cap-20',
    ...
    sectionTitleVi: 'Phỏng đoán và suy đoán',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹을지도 모르다' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '갈지도 모르다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추울지도 모르다' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '놀다', conjugated: '놀지도 모르다' },
    ],
  },
  {
    id: 'gr-trung-cap-21',
    ...
    sectionTitleVi: 'Phỏng đoán và suy đoán',
    relatedPatterns: [
      { id: 'gr-so-cap-53', distinction: 'Dùng để phỏng đoán dựa trên căn cứ đã trực tiếp chứng kiến/nghe thấy, khác với -(으)ㄹ 것 같다 có thể dùng cho cả phỏng đoán chủ quan không cần căn cứ cụ thể.' },
    ],
  },
  {
    id: 'gr-trung-cap-22',
    ...
    sectionTitleVi: 'Phỏng đoán và suy đoán',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹을걸요' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '갈걸요' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추울걸요' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '힘들다', conjugated: '힘들걸요' },
    ],
  },
  {
    id: 'gr-trung-cap-23',
  ...
  },
  {
    ...
    sectionTitleVi: 'Phỏng đoán và suy đoán',
    conjugationTable: [
      { stemType: 'Tính từ (quy tắc)', baseForm: '아프다', conjugated: '아픈가 보다' },
      { stemType: 'Tính từ, ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추운가 보다' },
      { stemType: 'Động từ (quy tắc)', baseForm: '오다', conjugated: '오나 보다' },
      { stemType: 'Động từ, ㄹ 받침', baseForm: '살다', conjugated: '사나 보다' },
    ],
  },
  {
    id: 'gr-trung-cap-25',
    ...
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '먹다', conjugated: '먹어 놓다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '굽다', conjugated: '구워 놓다' },
      { stemType: '르 bất quy tắc', baseForm: '부르다', conjugated: '불러 놓다' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '쓰다', conjugated: '써 놓다' },
    ],
  },
  {
    id: 'gr-trung-cap-26',
    ...
    sectionTitleVi: 'Diễn tả trạng thái hành động',
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '적다', conjugated: '적어 두다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '굽다', conjugated: '구워 두다' },
      { stemType: '르 bất quy tắc', baseForm: '부르다', conjugated: '불러 두다' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '쓰다', conjugated: '써 두다' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-25', distinction: 'Nghĩa gần giống -아/어 놓다 (mục 25), nhưng -아/어 두다 nhấn mạnh trạng thái duy trì lâu dài hơn, chuẩn bị cho tương lai xa hơn.' },
    ],
  },
  {
    id: 'gr-trung-cap-27',
    ...
    sectionTitleVi: 'Diễn tả trạng thái hành động',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '신다', conjugated: '신은 채로' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '켜다', conjugated: '켠 채로' },
      { stemType: 'ㄷ bất quy tắc', baseForm: '걷다', conjugated: '걸은 채로' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '살다', conjugated: '산 채로' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-16', distinction: '-(으)ㄴ 채로 nhấn mạnh trạng thái GIỮ NGUYÊN không đổi trong khi hành động khác diễn ra, khác với -(으)면서 diễn tả hai hành động song song, chủ động cùng lúc.' },
    ],
  },
  {
    id: 'gr-trung-cap-28',
    ...
    sectionTitleVi: 'Diễn tả trạng thái hành động',
    conjugationTable: [
      { stemType: 'Động từ (đang diễn ra)', baseForm: '보다', conjugated: '보는 대로' },
      { stemType: 'Động từ (đã hoàn thành)', baseForm: '결정하다', conjugated: '결정한 대로' },
      { stemType: 'ㄹ 받침 (đang diễn ra, lược ㄹ)', baseForm: '만들다', conjugated: '만드는 대로' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-18', distinction: 'V-는 대로 (làm theo đúng cách đang diễn ra) khác với V-자마자 (ngay sau khi) dù đôi khi hai cấu trúc trông giống nhau về nghĩa.' },
    ],
  },
  {
    id: 'gr-trung-cap-29',
  ...
  },
  {
    ...
    sectionTitleVi: 'Thái độ và thói quen',
    relatedPatterns: [
      { id: 'gr-trung-cap-44', distinction: '-곤 하다 nhấn mạnh tần suất lặp lại của hành động, còn -는 편이다 (mục 44) nhấn mạnh việc phân loại vào một mức độ/xu hướng nào đó.' },
    ],
  },
  {
    id: 'gr-trung-cap-31',
    ...
    sectionTitleVi: 'Thái độ và thói quen',
    conjugationTable: [
      { stemType: 'Tính từ (quy tắc)', baseForm: '예쁘다', conjugated: '예쁜 척하다' },
      { stemType: 'Tính từ, ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추운 척하다' },
      { stemType: 'Động từ (quy tắc)', baseForm: '자다', conjugated: '자는 척하다' },
      { stemType: 'Động từ, ㄹ 받침 (lược ㄹ)', baseForm: '알다', conjugated: '아는 척하다' },
    ],
  },
  {
    id: 'gr-trung-cap-32',
    ...
    conjugationTable: [
      { stemType: 'Tính từ (quy tắc)', baseForm: '빠르다', conjugated: '빠른 대신에' },
      { stemType: 'Tính từ, ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추운 대신에' },
      { stemType: 'Động từ (quy tắc)', baseForm: '낚시하다', conjugated: '낚시하는 대신에' },
      { stemType: 'Danh từ (trực tiếp)', baseForm: '불고기', conjugated: '불고기 대신에' },
    ],
  },
  {
    id: 'gr-trung-cap-33',
  ...
  },
  {
    ...
    sectionTitleVi: 'Lựa chọn',
    conjugationTable: [
      { stemType: 'Danh từ kết thúc phụ âm', baseForm: '밥', conjugated: '밥이라도' },
      { stemType: 'Danh từ kết thúc nguyên âm', baseForm: '커피', conjugated: '커피라도' },
    ],
  },
  {
    id: 'gr-trung-cap-35',
    ...
    sectionTitleVi: 'Lựa chọn',
    relatedPatterns: [
      { id: 'gr-so-cap-07', distinction: '-든지 -든지 nhấn mạnh rằng chọn lựa nào cũng không quan trọng, kết quả như nhau, khác với -거나 chỉ đơn thuần nêu lựa chọn giữa hai việc.' },
    ],
  },
  {
    id: 'gr-trung-cap-36',
    ...
    relatedPatterns: [
      { id: 'gr-trung-cap-43', distinction: 'Không nhầm -던 N (hành động còn dang dở/lặp lại trong quá khứ) với -았/었던 N (mục 43) vốn nhấn mạnh việc bắt đầu và chấm dứt trọn vẹn trong quá khứ, không kéo dài đến hiện tại.' },
    ],
  },
  {
    id: 'gr-trung-cap-37',
  ...
  },
  {
    ...
    sectionTitleVi: 'Hồi tưởng',
    relatedPatterns: [
      { id: 'gr-trung-cap-37', distinction: 'Cả hai đều hồi tưởng quá khứ, nhưng chỉ -던데요 mới dùng được để diễn tả quan điểm trái ngược với ý kiến đối phương một cách nhẹ nhàng; -더라고요 không mang được sắc thái phản bác này.' },
    ],
  },
  {
    id: 'gr-trung-cap-39',
    ...
    sectionTitleVi: 'Hồi tưởng',
    relatedPatterns: [
      { id: 'gr-trung-cap-37', distinction: 'Cách dùng khá giống -더라고요, nhưng -더군요 mang sắc thái cảm thán rõ và mạnh hơn.' },
    ],
  },
  {
    id: 'gr-trung-cap-40',
    ...
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '먹다', conjugated: '먹어 버리다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '굽다', conjugated: '구워 버리다' },
      { stemType: '르 bất quy tắc', baseForm: '부르다', conjugated: '불러 버리다' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '쓰다', conjugated: '써 버리다' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-41', distinction: '-아/어 버리다 thiên về cảm giác nhẹ nhõm khi trút bỏ gánh nặng, còn -고 말다 (mục 41) chỉ mang sắc thái tiếc nuối, không có nghĩa nhẹ nhõm.' },
    ],
  },
  {
    id: 'gr-trung-cap-41',
  ...
  },
  {
    ...
    sectionTitleVi: 'Phát hiện và kết quả',
    relatedPatterns: [
      { id: 'gr-trung-cap-70', distinction: '-다 보면 nói về kết quả SẼ xảy ra trong tương lai nếu tiếp tục hành động, khác với -다 보니(까) (mục 70) nói về kết quả ĐÃ xảy ra trong quá khứ.' },
    ],
  },
  {
    id: 'gr-trung-cap-72',
  ...
  },
  {
    ...
    sectionTitleVi: 'Phát hiện và kết quả',
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '가다', conjugated: '갔더니' },
      { stemType: 'ㄷ bất quy tắc', baseForm: '듣다', conjugated: '들었더니' },
      { stemType: '르 bất quy tắc', baseForm: '부르다', conjugated: '불렀더니' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '쓰다', conjugated: '썼더니' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-72', distinction: 'Chủ ngữ của -았/었더니 bắt buộc là ngôi thứ nhất (người nói tự trải nghiệm), khác với -더니 (mục 72) chủ ngữ luôn là ngôi thứ ba.' },
    ],
  },
  {
    id: 'gr-trung-cap-74',
    ...
    sectionTitleVi: 'Phát hiện và kết quả',
    relatedPatterns: [
      { id: 'gr-so-cap-21', distinction: '-다가는 luôn mang thêm hàm ý cảnh báo hậu quả tiêu cực, khác với -다가 (mục Sơ cấp) chỉ đơn thuần diễn tả hành động bị ngắt quãng.' },
    ],
  },
  {
    id: 'gr-trung-cap-75',
    ...
    sectionTitleVi: 'Phát hiện và kết quả',
    conjugationTable: [
      { stemType: 'Động từ, quá khứ (phụ âm cuối)', baseForm: '먹다', conjugated: '먹은 셈이다' },
      { stemType: 'Động từ, quá khứ (nguyên âm cuối)', baseForm: '하다', conjugated: '한 셈이다' },
      { stemType: 'Động từ, hiện tại', baseForm: '끝내다', conjugated: '끝내는 셈이다' },
      { stemType: 'ㄹ 받침 (hiện tại, lược ㄹ)', baseForm: '살다', conjugated: '사는 셈이다' },
    ],
  },
  {
    id: 'gr-trung-cap-76',
    ...
    conjugationTable: [
      { stemType: 'Tính từ (quy tắc)', baseForm: '크다', conjugated: '큰지' },
      { stemType: 'Tính từ, ㅂ bất quy tắc', baseForm: '아름답다', conjugated: '아름다운지' },
      { stemType: 'Động từ (quy tắc, hiện tại)', baseForm: '먹다', conjugated: '먹는지' },
      { stemType: 'ㄹ 받침 (động từ hiện tại, lược ㄹ)', baseForm: '살다', conjugated: '사는지' },
    ],
  },
  {
    id: 'gr-trung-cap-77',
    ...
    sectionTitleVi: 'Nhấn mạnh',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹을 수밖에 없다' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '갈 수밖에 없다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추울 수밖에 없다' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '놀다', conjugated: '놀 수밖에 없다' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-27', distinction: '-(으)ㄹ 수밖에 없다 nhấn mạnh tính TẤT YẾU, không còn lựa chọn nào khác, khác với -아/어야 하다 (mục Sơ cấp) chỉ đơn thuần nêu nghĩa vụ, bổn phận phải làm.' },
    ],
  },
  {
    id: 'gr-trung-cap-78',
    ...
    sectionTitleVi: 'Nhấn mạnh',
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹을 뿐이다' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '자다', conjugated: '잘 뿐이다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추울 뿐이다' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '알다', conjugated: '알 뿐이다' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-77', distinction: '-(으)ㄹ 뿐이다 nhấn mạnh tính duy nhất/giới hạn của sự việc, còn -(으)ㄹ 수밖에 없다 (mục 77) nhấn mạnh tính tất yếu, không có lựa chọn nào khác.' },
    ],
  },
  {
    id: 'gr-trung-cap-79',
    ...
    sectionTitleVi: 'Nhấn mạnh',
    conjugationTable: [
      { stemType: 'Danh từ kết thúc phụ âm', baseForm: '부모님', conjugated: '부모님이야말로' },
      { stemType: 'Danh từ kết thúc nguyên âm', baseForm: '친구', conjugated: '친구야말로' },
    ],
  },
  {
    id: 'gr-trung-cap-80',
    ...
    relatedPatterns: [
      { id: 'gr-trung-cap-82', distinction: 'Cấu trúc -게 khá phổ biến, dễ nhầm với -도록 (mục 82) tuy hai cấu trúc có thể thay thế cho nhau trong nhiều trường hợp mang nghĩa mục đích.' },
    ],
  },
  {
    id: 'gr-trung-cap-81',
    ...
    sectionTitleVi: 'Mục đích',
    relatedPatterns: [
      { id: 'gr-trung-cap-80', distinction: 'Có thể thay thế trực tiếp bằng -게 (mục 80) trong hầu hết các trường hợp, -게끔 chỉ khác về mức độ nhấn mạnh.' },
      { id: 'gr-trung-cap-82', distinction: '-게끔 ít phổ biến hơn -게 và -도록 (mục 82) trong giao tiếp hàng ngày, thường gặp nhiều hơn trong văn viết.' },
    ],
  },
  {
    id: 'gr-trung-cap-82',
    ...
    sectionTitleVi: 'Mục đích',
    relatedPatterns: [
      { id: 'gr-trung-cap-80', distinction: 'Ở nghĩa mục đích có thể thay -도록 bằng -게 (mục 80), nhưng ở nghĩa mức độ/thời gian thì không thể thay thế bằng -게.' },
    ],
  },
  {
    id: 'gr-trung-cap-83',
    ...
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹으나 마나' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '가나 마나' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추우나 마나' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '살다', conjugated: '사나 마나' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-84', distinction: '-(으)나 마나 nhấn mạnh việc làm hay không làm đều vô ích như nhau, còn -아/어봤자 (mục 84) nhấn mạnh dù CỐ GẮNG làm cũng không đạt được kết quả mong muốn.' },
    ],
  },
  {
    id: 'gr-trung-cap-84',
    ...
    sectionTitleVi: 'Diễn tả sự vô ích',
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '먹다', conjugated: '먹어 봤자' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추워 봤자' },
      { stemType: '르 bất quy tắc', baseForm: '부르다', conjugated: '불러 봤자' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '쓰다', conjugated: '써 봤자' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-83', distinction: '-아/어봤자 nhấn mạnh việc đã CỐ GẮNG làm nhưng không hiệu quả, còn -(으)나 마나 (mục 83) nhấn mạnh làm hay không làm kết quả như nhau.' },
    ],
  },
  {
    id: 'gr-trung-cap-85',
    ...
    conjugationTable: [
      { stemType: 'Quy tắc (phụ âm cuối)', baseForm: '먹다', conjugated: '먹을걸 그랬다' },
      { stemType: 'Quy tắc (nguyên âm cuối)', baseForm: '가다', conjugated: '갈걸 그랬다' },
      { stemType: 'ㄷ bất quy tắc', baseForm: '듣다', conjugated: '들을걸 그랬다' },
      { stemType: 'ㄹ 받침 (lược ㄹ)', baseForm: '살다', conjugated: '살걸 그랬다' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-22', distinction: 'Không nhầm -(으)ㄹ걸 그랬다 (hối hận, "biết thế đã...") với -(으)ㄹ걸요 (mục 22, phỏng đoán) — hai cấu trúc trông rất giống nhau khi rút gọn ở dạng thân mật.' },
    ],
  },
  {
    id: 'gr-trung-cap-86',
    ...
    sectionTitleVi: 'Hối hận',
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '먹다', conjugated: '먹었어야 했는데' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '춥다', conjugated: '추웠어야 했는데' },
      { stemType: '르 bất quy tắc', baseForm: '다르다', conjugated: '달랐어야 했는데' },
      { stemType: 'ㅅ bất quy tắc', baseForm: '짓다', conjugated: '지었어야 했는데' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-85', distinction: '-았/었어야 했는데 mang sắc thái trang trọng, nghiêm túc hơn -(으)ㄹ걸 그랬다 (mục 85), vốn mang tính khẩu ngữ, thân mật hơn.' },
    ],
  },
  {
    id: 'gr-trung-cap-87',
    ...
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '먹다', conjugated: '먹어 가지고' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '덥다', conjugated: '더워 가지고' },
      { stemType: '르 bất quy tắc', baseForm: '부르다', conjugated: '불러 가지고' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '바쁘다', conjugated: '바빠 가지고' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-01', distinction: '-아/어 가지고 là hình thức văn nói (khẩu ngữ) của -아/어서 khi mang nghĩa nguyên nhân "vì... nên".' },
      { id: 'gr-so-cap-13', distinction: '-아/어 가지고 cũng là hình thức văn nói của -아/어서 khi mang nghĩa trình tự hành động nối tiếp.' },
    ],
  },
  {
    id: 'gr-trung-cap-88',
    ...
    sectionTitleVi: 'Thời gian và trật tự hành động',
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '빌리다', conjugated: '빌려다가' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '굽다', conjugated: '구워다가' },
      { stemType: '르 bất quy tắc', baseForm: '부르다', conjugated: '불러다가' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '쓰다', conjugated: '써다가' },
    ],
    relatedPatterns: [
      { id: 'gr-so-cap-13', distinction: '-아/어다가 nhấn mạnh sự thay đổi địa điểm giữa hai hành động, khác với -아/어서 (mục Sơ cấp, nghĩa trình tự) không nhất thiết đổi địa điểm.' },
      { id: 'gr-so-cap-14', distinction: '-아/어다가 nhấn mạnh sự thay đổi địa điểm giữa hai hành động, khác với -고 (mục Sơ cấp) không nhất thiết đổi địa điểm.' },
    ],
  },
  {
    id: 'gr-trung-cap-89',
    ...
    sectionTitleVi: 'Thời gian và trật tự hành động',
    relatedPatterns: [
      { id: 'gr-so-cap-12', distinction: '-고서 gần nghĩa với -고 나서 (mục Sơ cấp) nhưng mang tính trang trọng hơn và nhấn mạnh trình tự rõ ràng hơn -고 đơn thuần.' },
    ],
  },
  {
    id: 'gr-trung-cap-90',
    ...
    sectionTitleVi: 'Thời gian và trật tự hành động',
    relatedPatterns: [
      { id: 'gr-so-cap-20', distinction: 'N-만에 thường kết hợp với V-(으)ㄴ 지 (mục Sơ cấp) để nhấn mạnh khoảng thời gian đã trôi qua kể từ một mốc nào đó.' },
    ],
  },
  {
    id: 'gr-trung-cap-91',
    ...
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '닫다', conjugated: '닫아지다' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '줍다', conjugated: '주워지다' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '끄다', conjugated: '꺼지다' },
      { stemType: '하다 (아 → 해)', baseForm: '정하다', conjugated: '정해지다' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-92', distinction: 'Cần phân biệt -아/어지다 (bị động, trạng thái tự nhiên xảy ra) với -게 하다 (mục 92, gây khiến, có tác nhân chủ động bắt người khác làm).' },
    ],
  },
  {
    id: 'gr-trung-cap-92',
  ...
  },
  {
    ...
    examples: [
      { ko: '약을 먹었는데 오히려 더 아파요.', vi: 'Tôi đã uống thuốc rồi nhưng ngược lại còn đau hơn.', romanization: 'ya-geul meo-geon-neun-de o-hi-ryeo deo a-pa-yo.', register: 'polite' },
  ...
  },
  {
    ...
    examples: [
      { ko: '이 식당은 음식이 맛있어요. 게다가 가격도 싸요.', vi: 'Quán này đồ ăn ngon. Hơn nữa giá còn rẻ.', romanization: 'i sik-ttang-eun eum-si-gi ma-si-sseo-yo. ge-da-ga ga-gyeok-tto ssa-yo.', register: 'polite' },
    ...
    sectionTitleVi: 'Phó từ liên kết câu',
    relatedPatterns: [
      { id: 'gr-trung-cap-10', distinction: 'Hai ý nối bằng 게다가 phải CÙNG CHIỀU; nếu ý sau trái chiều với ý trước phải dùng 반면(에) (mục 10) hoặc 그런데, không dùng 게다가.' },
    ],
  },
  {
    id: 'gr-trung-cap-95',
    ...
    examples: [
      { ko: '아무리 바빠도 밥은 먹어야 해요.', vi: 'Dù bận đến mấy cũng phải ăn cơm.', romanization: 'a-mu-ri ba-ppa-do ba-beun meo-geo-ya hae-yo.', register: 'polite' },
    ...
    sectionTitleVi: 'Phó từ liên kết câu',
    conjugationTable: [
      { stemType: 'Quy tắc', baseForm: '많다', conjugated: '많아도' },
      { stemType: 'ㅂ bất quy tắc', baseForm: '어렵다', conjugated: '어려워도' },
      { stemType: '으 bất quy tắc (lược 으)', baseForm: '바쁘다', conjugated: '바빠도' },
      { stemType: '하다 (아 → 해)', baseForm: '생각하다', conjugated: '생각해도' },
    ],
    relatedPatterns: [
  ...
  },
  {
    ...
    examples: [
      { ko: '만약 내일 비가 오면 소풍은 취소예요.', vi: 'Nếu ngày mai trời mưa thì buổi dã ngoại sẽ bị hủy.', romanization: 'ma-nyak nae-il bi-ga o-myeon so-pung-eun chwi-so-ye-yo.', register: 'polite' },
    ...
    sectionTitleVi: 'Phó từ liên kết câu',
    conjugationTable: [
      { stemType: '(으)면, quy tắc phụ âm cuối', baseForm: '있다', conjugated: '있으면' },
      { stemType: '(으)면, quy tắc nguyên âm cuối', baseForm: '오다', conjugated: '오면' },
      { stemType: '다면, động từ hiện tại', baseForm: '당첨되다', conjugated: '당첨된다면' },
      { stemType: '다면, quá khứ', baseForm: '선택하다', conjugated: '선택했다면' },
    ],
    relatedPatterns: [
      { id: 'gr-trung-cap-14', distinction: '만약 thường đi kèm -다면 (mục 14) khi nhấn mạnh giả định khó xảy ra hoặc hoàn toàn không có khả năng.' },
      { id: 'gr-so-cap-46', distinction: '만약 cũng có thể đi kèm -(으)면 (mục Sơ cấp) cho điều kiện có khả năng xảy ra bình thường; bản thân -(으)면/-다면 đã đủ diễn đạt điều kiện, 만약 chỉ là phần nhấn mạnh thêm.' },
    ],
  },
  {
    id: 'gr-trung-cap-97',
